...
// PWA manifest icon, 192×192. Brand gradient square + Fit Sync "F" glyph.
...
export function GET() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="128" height="128" viewBox="0 0 1024 1024" fill="#fff" fillOpacity="0.95" xmlns="http://www.w3.org/2000/svg">
